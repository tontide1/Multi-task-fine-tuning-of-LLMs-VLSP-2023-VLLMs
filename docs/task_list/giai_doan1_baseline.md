...
- [ ] Xác nhận đầy đủ 4 nhóm benchmark:
  ...
  - [ ] `wikipediaqa_vi` (MCQ)
  - [ ] `exams_vi` (đúng toàn bộ subtask)
  - [ ] `comprehension` (MCQ)
- [ ] Khóa parser output cho từng nhóm task:
  - [ ] parser riêng cho `lambada_vi`
  - [ ] parser MCQ cho `wikipediaqa_vi`, `exams_vi`, `comprehension`
...
- [ ] Chốt “baseline eval contract” v1: cùng 1 config, cùng 1 parser rule, cùng 1 quy tắc tính điểm cho các lần chạy sau.
